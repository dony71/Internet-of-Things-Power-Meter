...
//#define TIME_SYNC_PERIOD 60 // [s]
// NTP server from which to fetch the time
static const char * ntpServerName = "time.google.com";

static int timeZone = -8;  // Pacific Standard Time (USA)
//const int timeZone = -7;  // Pacific Daylight Time (USA)
static const char * timeZoneName = "PST";  // Pacific Standard Time

const int daylightMonth = 3;  // March 2nd Sunday
const int standardMonth = 11;  // November 1st Sunday

#define ENABLE_INTERNET // Comment thus line to remove all internet related functionalities
static const char * wifi_ssid = "HARRIER";
static const char * wifi_password = "4088138208";

// MQTT server configuration
static const char * mqtt_server = "10.168.1.40";
//static const char * mqtt_server = "192.168.1.102";
static const unsigned int mqtt_port = 1883;
static const char * hostName = "PowerMeter";
